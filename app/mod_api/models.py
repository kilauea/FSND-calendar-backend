...
class Calendar(Base):
    ...
    def __init__(
        ...
        if date_modified:
            self.date_modified = datetime.strptime(date_modified, '%Y-%m-%d, %H:%M:%S')
        else:
    ...
    def __repr__(self):
        return json.dumps({
            ...
            'auto_decorate_task_details_hyperlink': self.auto_decorate_task_details_hyperlink,
            'hide_past_tasks': self.hide_past_tasks,
            'days_past_to_keep_hidden_tasks': self.days_past_to_keep_hidden_tasks
        })
