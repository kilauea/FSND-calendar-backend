...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('task', sa.Column('user_id', sa.INTEGER(),
                                    autoincrement=False,
                                    nullable=False))
    op.create_foreign_key('task_user_id_fkey', 'task',
    ...
    op.create_table('auth_user',
                    ...
                    sa.Column('date_modified', postgresql.TIMESTAMP(),
                              server_default=sa.text(
                        'CURRENT_TIMESTAMP'),
                        autoincrement=False, nullable=True),
                    ...
                    sa.Column('email', sa.VARCHAR(length=128),
                              autoincrement=False, nullable=False),
                    sa.Column('password', sa.VARCHAR(length=192),
                              autoincrement=False, nullable=False),
                    sa.Column('role', sa.SMALLINT(),
                              autoincrement=False, nullable=False),
